...
def CSM_filter(CSM, zero_order_CSM, states, epsilon_machine, ts, L, verbose = False):
...
def run_tests(fname, CSM, zero_order_CSM, states, epsilon_machine, L, L_max = None, metric = None, type = 'CSM', print_predictions = False, print_state_series = False, verbose = False):
