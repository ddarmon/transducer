# Estimate the causal states for a discrete, scalar
# time series using state merging (a la Shalizi's 
# LICORS work), as opposed to state splitting (a la
# Shalizi's CSSR work).
# 
...
ofile = open('timeseries_synthetic/complex-csm.dat')
...
print 'The statistical complexity is {}...'.format(C)